...
class UniteMesureController extends AbstractController
{
    ...
    /**
     * @Route("/{um_id}", name="unite_mesure_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{um_id}/edit", name="unite_mesure_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{um_id}", name="unite_mesure_delete", methods={"DELETE"})
     */
    public function delete(Request $request, UniteMesure $uniteMesure): Response
    {
        if ($this->isCsrfTokenValid('delete'.$uniteMesure->getUm_id(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
