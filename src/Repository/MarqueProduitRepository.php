...
/**
 * @method MarqueProduit|null find($marque_id, $lockMode = null, $lockVersion = null)
...
class MarqueProduitRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return MarqueProduit[] Returns an array of MarqueProduit objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?MarqueProduit
    {
        return $this->createQueryBuilder('m')
            ->andWhere('m.exampleField = :val')
            ->setParameter('val', $value)
